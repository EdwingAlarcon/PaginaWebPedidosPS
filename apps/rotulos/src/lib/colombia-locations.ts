// Generated from Datos Abiertos Colombia / DANE DIVIPOLA (gdxc-w37w).
// Source: https://www.datos.gov.co/Mapas-Nacionales/DIVIPOLA-C-digos-municipios/gdxc-w37w

export type DepartmentOption = { code: string; name: string };
export type MunicipalityOption = { code: string; name: string; departmentCode: string };
