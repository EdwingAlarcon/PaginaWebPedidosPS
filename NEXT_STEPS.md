...
1. ~~**Fotos que faltan**~~ — **completado 2026-09-22: 319/319 con foto.** 19 fotos
   subidas en dos tandas (7 + 12) vía `scripts/import-product-photos.ts <carpeta>
   --commit`, archivos convertidos a JPG con `sharp` y renombrados al código
